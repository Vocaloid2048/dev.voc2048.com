...
**首頁 (/)** — Home Intro + Quote + PinnedWorks + Footer
- Home Intro: 透過 GUI (Markdown) 設置標題、副標題與職業描述，支援自定義樣式。
- 引言: **「讓冷冰冰的軟體，跳出窩心的溫度」**
...
- [ ] 2.7 檔案管理: 上傳 + 列表 + 刪除
- [x] 2.8 資訊設定: GUI 式編輯首頁簡介與個人簡介
- [ ] 2.9 系統設置: 背景圖上傳 + 櫻花開關 + 網站配置
